    ...
    <section class="hero">
      <div class="container">
        <div class="hero-content">
          ...
          <p class="tagline">东子证券</p>
          <h1>专业投资<br/>研究平台</h1>
          <p class="subtitle">
            以数据驱动的板块评分体系和黑马挖掘模型，精准把握市场脉搏。
          </p>
    ...
    <section class="section section-alt">
      <div class="container">
        <div class="section-header fade-in" ref="aboutTitle">
          ...
          <h2>关于东子证券</h2>
          <p class="subtitle">以数据为基石，以模型为引擎，为投资者创造长期价值。</p>
        </div>
        <div class="card fade-in" ref="aboutContent" style="max-width:720px;margin:0 auto;">
          <p style="font-size:17px;color:var(--text-secondary);line-height:2;margin-bottom:20px;">
            东子证券是一家专注于证券市场研究与投资咨询的专业金融机构。我们拥有自主研发的板块评分体系，从板块指数涨幅、资金持续流入、趋势强度、人气热度、基本面五大维度，对A股各大板块进行全方位量化评分。
          </p>
          <p style="font-size:17px;color:var(--text-secondary);line-height:2;margin-bottom:24px;">
            同时，我们独创黑马板块与黑马个股挖掘模型，通过启动中与飙升中板块筛选、人气榜过滤、技术面突破确认等多重机制，精准锁定最具上涨潜力的投资标的。
          </p>
    ...
    <section class="section section-alt">
      <div class="container">
        <div class="section-header fade-in" ref="horseSectorTitle">
          ...
          <h2>黑马板块追踪</h2>
          <p class="subtitle">启动与飙升板块实时追踪 · 2026年7月6日</p>
        </div>
        <div class="card-grid">
          ...
          <div class="table-wrap fade-in" ref="sectorGain">
            ...
            <div style="padding:24px 32px;">
              <div v-for="(item, i) in gainReviews" :key="i" style="display:flex;align-items:center;gap:12px;padding:14px 0;border-bottom:1px solid var(--border);font-size:15px;">
                <span class="tag" :class="item.tagClass">{{ item.tag }}</span>
                <span style="flex:1;color:var(--text-secondary);">{{ item.desc }}</span>
                <span style="font-weight:600;color:#c0392b;">{{ item.gain }}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="card-grid">
          ...
          <div class="table-wrap fade-in" ref="stockGain">
            ...
            <div style="padding:24px 32px;">
              <div v-for="(item, i) in stockGains" :key="i" style="display:flex;align-items:center;gap:12px;padding:14px 0;border-bottom:1px solid var(--border);font-size:15px;">
          ...
          <div class="contact-grid">
            <div class="contact-info">
              ...
              <div class="contact-info-item">
                ...
                <div>
                  <strong>服务热线</strong>
                  <p style="color:var(--text-secondary);font-size:14px;margin-top:4px;">400-000-0000</p>
                </div>
              </div>
              <div class="contact-info-item">
                <div class="icon">📧</div>
                <div>
                  <strong>电子邮箱</strong>
                  <p style="color:var(--text-secondary);font-size:14px;margin-top:4px;">service@dongzisec.com</p>
                </div>
              </div>
              <div class="contact-info-item">
                <div class="icon">📍</div>
                <div>
                  <strong>公司地址</strong>
                  <p style="color:var(--text-secondary);font-size:14px;margin-top:4px;">北京市朝阳区金融街88号</p>
                </div>
              </div>
            </div>
            <div class="contact-form">
              ...
              <div v-if="submitted" style="margin-top:16px;padding:16px;background:var(--bg-alt);border-radius:14px;text-align:center;font-size:14px;color:var(--text-secondary);">
                ✓ 提交成功，感谢您的咨询。
              </div>
            </div>
          </div>
